...
FF?.\\
    ...
    El protocolo ARP es un estándar TCP/IP que asocia las direcciones IP y MAC de los equipos conectados a la red. Un ejemplo de ataque utilizando ARP es el ARP-Poisoning consiste en enviar paquetes ARP falsos para que un dispositivo llene su tabla ARP con información falsa
\end{enumerate}
\end{document}
